...
access_key_id=credentials['scenario2']['aws_access_key_id']
secret_access_key=credentials['scenario2']['aws_secret_access_key']
region=credentials['scenario2']['region']
iamuser=credentials['scenario2']['iamuser']
